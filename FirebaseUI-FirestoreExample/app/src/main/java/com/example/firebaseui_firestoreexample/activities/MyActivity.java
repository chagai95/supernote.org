...
//      create a list of items for the spinner.
    ...
    void hideKeyboard() {
        ...
        //Find the currently focused searchView, so we can grab the correct window token from it.
        View view = activity.getCurrentFocus();
        //If no searchView currently has focus, create a new one, just so we can grab a window token from it
        if (view == null) {
